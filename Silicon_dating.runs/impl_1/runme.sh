...
HD_PWD='C:/Users/RISHIK NAIR/Downloads/To-do/Silicon_dating/Silicon_dating.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log silicon_dating_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source silicon_dating_top.tcl -notrace
